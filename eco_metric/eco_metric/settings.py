"""
Django settings for eco_metric project.
...
ROOT_URLCONF = 'eco_metric.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / "eco_met" / "templates"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'eco_metric.wsgi.application'
...
# tracker = EmissionsTracker(output_dir=str(output_dir), measure_power_secs=1)
